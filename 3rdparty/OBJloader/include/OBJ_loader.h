...
// Define OBJL_SUPPRESS_CONSOLE_OUTPUT before including this header to silence loader logs.
#ifndef OBJL_SUPPRESS_CONSOLE_OUTPUT
	...
	public:
		...
		bool LoadFile(std::string Path)
		{
			...
			while (std::getline(file, curline))
			{
				...
				if (algorithm::firstToken(curline) == "o" || algorithm::firstToken(curline) == "g" || (!curline.empty() && curline[0] == 'g'))
				{
					if (!listening)
					{
						listening = true;
